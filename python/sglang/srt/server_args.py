...
class ServerArgs:
    ...
    pvd_transfer_max_inflight: Optional[int] = None
    ...
    def _handle_attention_backend_compatibility(self):
        ...
        if (
            ...
            assert self.prefill_attention_backend != "cutedsl_mla", (
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            "--pvd-full-kv-fanin-rank-packed",
            action=argparse.BooleanOptionalAction,
            default=ServerArgs.pvd_full_kv_fanin_rank_packed,
        ...
        parser.add_argument(
            ...
            type=int,
            default=ServerArgs.pvd_transfer_staging_budget_bytes,
            help="Per-worker byte budget for PVD transfer staging allocations "
            "(P packing, V repacking, D receive). Required with "
            "--disaggregation-topology pvd; must be a positive integer.",
        )
        parser.add_argument(
            "--pvd-transfer-max-inflight",
            type=int,
            default=ServerArgs.pvd_transfer_max_inflight,
            help="Maximum number of PVD transfers this worker may have "
            "in flight, including draining and quarantined ones. Required "
            "with --disaggregation-topology pvd; must be a positive integer.",
        )
        parser.add_argument(
